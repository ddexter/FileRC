 ...
 */
public class FileTrackerPlugin extends AbstractUIPlugin implements
	IWorkbenchListener {
	...
	// The shared instance
	private static FileTrackerPlugin plugin;
	...
	public FileTrackerPlugin getPlugin() {
		return plugin;
	}
}
